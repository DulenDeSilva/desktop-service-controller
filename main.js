...
// Update these to match the user's machine
const NODE_EXE = 'C:\\nvm4w\\nodejs\\node.exe';
const NPM_CLI = 'C:\\nvm4w\\nodejs\\node_modules\\npm\\bin\\npm-cli.js';

// Update these to match the target project
const services = {
    frontend: {
        process: null,
        status: 'stopped',
        cwd: 'C:\\Users\\dulen\\OneDrive\\Desktop\\ITMS _UAT\\Portfolio__manager',
        args: ['start']
    },
    backend: {
        process: null,
        status: 'stopped',
        cwd: 'C:\\Users\\dulen\\OneDrive\\Desktop\\ITMS _UAT\\Portfolio_manager_backend',
        args: ['run', 'dev']
    }
};
